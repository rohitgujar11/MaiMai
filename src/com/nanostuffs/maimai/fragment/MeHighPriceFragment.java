...
public class MeHighPriceFragment extends Fragment implements IXListViewListener {
				...
				try {
					...
					if (ja.length() == 0) {
						...
						if (mItem.size() != 0) {
							...
							mItemListView
									.setXListViewListener(MeHighPriceFragment.this);
...
//					+ mValues.get(position).getItemId();
		...
		private boolean checkInternetConnection() {
			...
			if (cm.getActiveNetworkInfo() != null
				...
				builder.setMessage("Internet not available, Cross che`k your internet connectivity and try again");
				builder.setTitle("Warning !");
				builder.setIcon(R.drawable.alert);
				builder.setPositiveButton("OK",
						new DialogInterface.OnClickListener() {
